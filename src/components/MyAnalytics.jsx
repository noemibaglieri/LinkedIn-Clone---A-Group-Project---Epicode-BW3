...
const MyAnalytics = () => {
  return (
    <Container className="p-0 bg-white rounded-3 border mt-3">
      {/*Analisi*/}
      <div className=" p-3 border mt-3 position-relative" style={{ minHeight: "250px" }}>
        <Row>
        ...
        <div className="position-absolute rounded-5 bottom-0 start-0 w-100 border-top p-3 bg-white">
